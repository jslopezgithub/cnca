...
Label1.Caption = Range("A8")
Label3.Caption = Range("B8")
End Sub
...
Range("G8").Value = TextBox2

Range("E9").Value = TextBox3
Range("G9").Value = TextBox4

Range("E10").Value = TextBox5
Range("G10").Value = TextBox6
